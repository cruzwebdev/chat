      ...
      this.afAuth.auth
        ...
        .then(user => {
          ...
          const updatedUser = {
            ...
            quote:
              "List is like a box of chocolates, you never know what you are going to get!",
  ...
  public logout(): void {
    ...
    this.afAuth.auth.signOut().then(() => {
      ...
      this.alertService.alerts.next(
        new Alert("You have been successfully signed out", AlertType.Success)
      );
    });
  }
